        ...
        <div className="flex min-h-screen">
            <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-8 bg-white">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8">
                        <h1 className="text-2xl font-semibold text-[#1E293B] mb-2">Welcome Back!</h1>
                        <p className="text-[#64748B]">Sign in to access your dashboard and continue optimizing your QA process.</p>
                    </div>
                    ...
                    <form action={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    name="email"
                                    required
                                    className="w-full p-4 pl-11 rounded-md border border-[#CBD5E1] focus:outline-none focus:ring-2 focus:ring-[#0F4C5C] focus:border-transparent transition-all text-[#1E293B] placeholder:text-[#94A3B8]"
                                />
                        ...
                        <div className="flex justify-end">
                            <Link href="#" className="text-sm text-[#0F4C5C] hover:text-[#1B7B7F] font-medium transition-colors">
                                Forgot Password?
                            </Link>
                        </div>
                        ...
                        <button
                            ...
                            onClick={onLogin}
                            disabled={isPending}
                            className="w-full bg-[#0F4C5C] text-white py-4 rounded-lg font-medium hover:bg-[#0D3F4A] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm hover:shadow-md"
                        >
                            {isPending ? 'Signing in...' : 'Sign In'}
                        </button>

                        <div className="text-center">
                            {state?.success && <p className="text-[#0F4C5C]">Login successful</p>}
                            {state?.error && <p className="text-red-500">Login failed. Verify your email</p>}
                        </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-[#64748B]">
                            ...
                            <Link href="/signup" className="text-[#0F4C5C] hover:text-[#1B7B7F] font-semibold transition-colors">
                                Sign Up
                            </Link>
                        </p>
                    </div>
